    ...
    <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/tsvet-zelenogorska-main.webp"
            alt="ЖК Коллекционер"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 text-center text-white pt-20">
          ...
          <div className="space-y-4 mb-8 md:mb-12 text-lg md:text-xl font-light">
            <p className="opacity-90">Камерный дом в Курортном районе у Финского залива</p>
            <p className="opacity-90">На проспекте Ленина, 38</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12 text-center max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-xl font-medium">IV кв. 2028</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm opacity-75 uppercase tracking-wide">Стоимость</p>
              <p className="text-xl font-medium">от 15.38 млн руб.</p>
            </div>
            <div className="space-y-2">
              <p className="text-sm opacity-75 uppercase tracking-wide">Площадь</p>
              <p className="text-xl font-medium">от 30.9 м²</p>
            </div>
          </div>
