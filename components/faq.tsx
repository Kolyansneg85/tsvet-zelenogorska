...
const faqData = [
  {
    question: "Срок сдачи и количество квартир в ЖК «Коллекционер»",
    answer:
  ...
  {
    question: "Планировки и цены квартир в клубном доме",
    answer:
  ...
  {
    question: "Парковка в доме «Коллекционер»: сколько машино-мест предусмотрено?",
    answer:
  ...
  {
    question: "Есть ли коворкинг и переговорные в доме?",
    answer:
  ...
  {
    question: "Какие системы безопасности установлены?",
    answer:
  ...
  {
    question: "Инфраструктура двора дома «Коллекционер»: что входит?",
    answer:
  ...
  {
    question: "Какие инженерные системы предусмотрены в доме?",
    answer:
  ...
  {
    question: "С какой отделкой сдаются квартиры?",
    answer:
